...
function loadcalendar() {
    ...
    if ( typeof jq !== 'undefined' && jq('#append_parent').length ) {
        var calendarParent = jq('#append_parent').clone();
        jq('#append_parent').remove();
        jq('body').prepend(calendarParent);
    }
...
function loadcss(cssname) {
	...
	document.write('<link rel="stylesheet" type="text/css" href="/static/css/'+cssname+'.css" />');
}
