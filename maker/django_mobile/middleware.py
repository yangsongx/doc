...
class MobileDetectionMiddleware(object):
    user_agents_test_match = (
        ...
        "iPhone", "blackberry", "blazer", "danger", "ericsson", "Google\s+Wireless\s+Transcoder",
        "htc", "iemobile", "ipaq", "iphone", "ipod", "lg",
        "mobile", "mot", "moto", "motorola", "nec\-", 
        "netfront", "nokia", "opera\s+mini", "palm", "palmsource", "panasonic",
        )
...
def is_mobile_req(request):
    return request.flavour == "mobile"